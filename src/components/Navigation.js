...
function Navigation() {
  ...
  return (
    <Navbar className="fixed-top" bg="light" expand="lg">
      <Container>
        <LinkContainer to="/">
          <Navbar.Brand className="logo">Stock Logistics</Navbar.Brand>
        </LinkContainer>
            ...
            {!user && (
              <>
                <LinkContainer to="/login">
                  <Nav.Link className="custom-link">Login</Nav.Link>
                </LinkContainer>

                <LinkContainer to="/signup">
                  <Nav.Link className="custom-link">Register</Nav.Link>
                </LinkContainer>
              </>
            )}
            ...
            {user && (
              <>
                <Nav.Link
                  ...
                  onClick={() => {
                    window.open(
                      `http://localhost:3006/login/${user.email}`,
                      "_blank",
                      "noreferrer"
                    );
                  }}
